...
<header>
    <div class="titulo">
        ...
        <p>Diagnósticos y tratamientos registrados a tus pacientes</p>
    </div>
</header>
...
<section class="tabla-citas" style="margin-top: 30px; background: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
            ...
            <tbody>
                @foreach ($historial as $registro)
                    <tr style="border-bottom: 1px solid #eee;">
                        <td style="padding: 12px;">{{ $registro['paciente'] }}</td>
    ...
    @else
        <p style="color: #666; padding: 10px 0;">No tienes historiales clínicos registrados.</p>
    @endif
